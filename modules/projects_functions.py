...
class ProjectFunctions:
    ...
    def create_clear_project_form(self):
        ...
        return FORM(DIV(BUTTON("Clear Project ", I(_class='icon-trash icon-white'), _type='submit',
    ...
    def build_transcription_list(self, project, transcriptions):
        ...
        for transcription in transcriptions:
            ...
            transcription_dictionary['button'] = A(BUTTON('Accept', _class="btn btn-success"),
                                                   callback=URL('accept_transcription',
